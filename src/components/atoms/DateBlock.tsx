...
function DateBlock({
  ...
  const responsiveContainerClasses: Record<Size, string> = {
    small:
      "p-1 w-12 rounded md:p-1.5 md:w-13 lg:p-3 lg:w-16.5 lg:rounded-md 3xl:p-3.5 3xl:w-19 3xl:rounded-lg",
  ...
  return (
    ...
    >
      <span
        className={`uppercase text-blue-300 ${responsiveMonthClasses[startSize]}`}
      >
        {monthName}
      </span>
      <span
        className={`font-bold text-white ${responsiveDateClasses[startSize]}`}
      >
        {date}
      </span>
