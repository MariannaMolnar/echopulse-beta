...
function FacebookEventButtonResponsive({ event, startSize = "midi" }: FbEventProps) {
  ...
  const responsiveLinkClasses: Record<Size, string> = {
    small: "text-xs py-1 px-2 rounded md:py-1.5 md:px-2.5 xl:text-sm xl:py-2 xl:px-4 4xl:text-base 4xl:py-2.5 4xl:px-5 4xl:rounded-md",
